...
export default function ExhibitionModal({ isOpen, onClose, exhibition }: Props) {
    ...
    return (
        <BaseModal isOpen={isOpen} onClose={onClose}>
            ...
            <svg className={`${styles.blobBlue} ${styles.blob}`} width="231" height="302" viewBox="0 0 231 302" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className={`${styles.blobGreen} ${styles.blob}`} width="189" height="221" viewBox="0 0 189 221" fill="none" xmlns="http://www.w3.org/2000/svg">
